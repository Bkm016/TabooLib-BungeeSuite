...
public class ProxiedPlayerTag {
	...
	public static ProxiedPlayerTag getInst() {
		if (inst == null) {
			synchronized (ProxiedPlayerTag.class) {
				if (inst == null) {
					inst = new ProxiedPlayerTag();
				}
			}
		}
		return inst;
